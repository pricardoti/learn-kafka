...
public class EmailService {
    ...
    private static final String ORDER_TOPIC_GROUP = "ECOMMERCE_EMAIL_PROCESS";
    private static final Duration CONSUMER_TIME_POLL = Duration.ofMillis(500);

    public static void main(String[] args) throws InterruptedException {
        var consumer = new KafkaConsumer<String, String>(properties());
        consumer.subscribe(List.of(KAFKA_TOPIC_EMAIL));
        ...
        while (true) {
            ...
            records.forEach(record -> {
                ...
                logger.info(":: Order value: Thanks for your order! " + record.value());
